...
class TLearning_EffNetB7(nn.Module):
    def __init__(self):
        super(TLearning_EffNetB7,self).__init__()
        self.pretrained = models.efficientnet_b7(pretrained=True, progress=True)
